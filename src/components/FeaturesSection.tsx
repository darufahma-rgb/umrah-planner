      ...
      <div className="container mx-auto px-3 md:px-4">
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-10 h-10 md:w-12 md:h-12 mx-auto mb-2 bg-gradient-to-br from-accent via-gold-light to-accent border border-accent/50 flex items-center justify-center rotate-45 shadow-lg shadow-accent/20">
                <feature.icon className="w-4 h-4 md:w-5 md:h-5 text-primary -rotate-45" />
              </div>
