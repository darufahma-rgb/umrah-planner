    ...
    <section className="relative min-h-[120svh] flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center container mx-auto px-4 pt-24 pb-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <h1 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-primary-foreground leading-relaxed tracking-wide">
        ...
        >
          {destinations.map((dest, index) => (
            <motion.div
              ...
              className="group relative h-24 sm:h-32 md:h-44 lg:h-52 rounded-xl md:rounded-2xl overflow-hidden cursor-pointer"
              onClick={scrollToItinerary}
            >
              ...
              <div className="absolute bottom-2 left-2 right-2 md:bottom-3 md:left-3 md:right-3">
                <div className="bg-white/10 backdrop-blur-md rounded-lg md:rounded-xl p-2 md:p-3 border border-white/20">
                  <h3 className="font-sans text-sm sm:text-base md:text-lg lg:text-xl text-white font-semibold leading-tight">
                    {dest.name}
                  </h3>
                  <p className="text-white/70 text-[9px] sm:text-[10px] md:text-xs tracking-wider uppercase hidden sm:block">
                    {dest.subtitle}
                  </p>
                </div>
              </div>
